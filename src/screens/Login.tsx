    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1, backgroundColor: colors.bg }}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <LinearGradient colors={colors.gradPrimary as any} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}
          ...
          <View style={{ width: 84, height: 84, borderRadius: 24, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
            <Image source={LOGO} style={{ width: 72, height: 72, borderRadius: 18 }} resizeMode="contain" />
          </View>
          <T size="hero" weight="900" color="#fff">EL QANOT</T>
